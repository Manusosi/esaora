  ...
  return (
    <footer className="bg-[#0A1628] border-t border-white/10">
      ...
      <div className="relative">
        <svg viewBox="0 0 1440 60" className="w-full -mt-1 opacity-10" preserveAspectRatio="none">
          <path d="M0,30 C360,60 1080,0 1440,30 L1440,0 L0,0 Z" fill="#0E7B74" />
        </svg>
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-[#0E7B74] text-xs tracking-wider">OCEAN RESILIENCE ALLIANCE</div>
              </div>
            </div>
            <p className="text-white/50 text-sm leading-relaxed mb-4 max-w-xs">{t.footer.tagline}</p>
            <p className="text-white/30 text-xs leading-relaxed mb-5">{t.footer.charter}</p>
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  key={i}
                  href={s.href}
                  className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-white/50 hover:bg-[#0E7B74] hover:text-white transition-all hover:scale-110 duration-200"
                >
                  {s.icon}
                </a>
              ))}
          ...
          <div>
            ...
            <div className="space-y-2">
              <a href={`mailto:${t.footer.email}`} className="flex items-center gap-2 text-white/50 hover:text-white text-sm transition-colors">
